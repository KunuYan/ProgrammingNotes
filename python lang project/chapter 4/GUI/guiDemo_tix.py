...
# there are tk extention module that make tk look more prettier and like a native
# GUI applications: tix and ttk, search them on your own time. revisit chapter 4: extending tkinter
def ev_clear():
